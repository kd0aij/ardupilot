...
protected:
    ...
    virtual void        setup_motors(MotorFrame::CLASS frame_class, motor_frame_type frame_type);
    ...
    MotorFrame::CLASS   _last_frame_class; // most recently requested frame class (i.e. quad, hexa, octa, etc)
