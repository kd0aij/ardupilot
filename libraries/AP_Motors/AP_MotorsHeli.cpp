...
// init
void AP_MotorsHeli::init(FRAME frame_class, motor_frame_type frame_type)
{
    ...
    set_initialised_ok(frame_class == FRAME::HELI);
...
void AP_MotorsHeli::set_frame_class_and_type(FRAME frame_class, motor_frame_type frame_type)
{
    set_initialised_ok(frame_class == FRAME::HELI);
}
    ...
    if (_servo_test_cycle_counter > 0){
        ...
        switch (_servo_mode) {
            ...
            case SERVO_CONTROL_MODE_MANUAL_MAX:
                ...
                if (_frame_class == FRAME::HELI_DUAL ||
                    _frame_class == FRAME::HELI_QUAD) {
                    _yaw_in = 0;
                } else {
                    _yaw_in = 1;
                }
