...
void AP_Motors6DOF::setup_motors(FRAME frame_class, motor_frame_type frame_type)
{
    ...
    switch ((SUB_FRAME)frame_class) {
        //                 Motor #              Roll Factor     Pitch Factor    Yaw Factor      Throttle Factor     Forward Factor      Lateral Factor  Testing Order
    case SUB_FRAME::BLUEROV1:
    ...
    case SUB_FRAME::VECTORED_6DOF_90DEG:
    ...
    case SUB_FRAME::CUSTOM:
        // Put your custom motor setup here
        //break;

    case SUB_FRAME::SIMPLEROV_3:
        add_motor_raw_6dof(AP_MOTORS_MOT_1,     0,              0,              -1.0f,          0,                  1.0f,               0,              1);
        add_motor_raw_6dof(AP_MOTORS_MOT_2,     0,              0,              1.0f,           0,                  1.0f,               0,              2);
        add_motor_raw_6dof(AP_MOTORS_MOT_3,     0,              0,              0,              -1.0f,              0,                  0,              3);
        break;
    case SUB_FRAME::SIMPLEROV_4:
    case SUB_FRAME::SIMPLEROV_5:
    default:
        add_motor_raw_6dof(AP_MOTORS_MOT_1,     0,              0,              -1.0f,          0,                  1.0f,               0,              1);
        add_motor_raw_6dof(AP_MOTORS_MOT_2,     0,              0,              1.0f,           0,                  1.0f,               0,              2);
...
{
    if ((SUB_FRAME)_last_frame_class == SUB_FRAME::VECTORED) {
        output_armed_stabilizing_vectored();
    } else if ((SUB_FRAME)_last_frame_class == SUB_FRAME::VECTORED_6DOF) {
