...
//    typedef DBGprint::Otype DBGTYPE;
    if (dbgct4 == 0) 
        DBGprint::dbgprint(DBGTYPE::PRINTF, 1000, 10, "PRINTF time: %f\n", t_sec);
    if (dbgct4 == 1) 
        DBGprint::dbgprint(DBGTYPE::CONSOLE, 1000, 1000, "CONSOLE time: %6.3f\n", t_sec);
    if (dbgct4 == 2) 
        DBGprint::dbgprint(DBGTYPE::GCS, 1000, 100, "GCS time: %f", t_sec);
    dbgctr++;
